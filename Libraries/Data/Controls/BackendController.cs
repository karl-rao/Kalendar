...
namespace Kalendar.Zero.Data.Controls
{
    ...
    public class BackendController : Controller
    {
            ...
            get
            {
                ...
                try
                {
                    if (Session[Utility.Config.SessionName] != null)
                        adminInfo = (DB.Entity.Base.AccountPO)Session[Utility.Config.SessionName];
                    else
        ...
        private DB.Entity.Base.AccountPO ReadAdminInfoFromCookie()
        {
            ...
            if (ticket != null)
            {
                DB.Entity.Base.AccountPO entity = Utility.DataCache.Account.GetEntity(ticket.UserData);
